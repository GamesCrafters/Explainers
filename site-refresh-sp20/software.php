...
<body>
    ...
    <div class="page-content">
        <div class="page-content-wrapper">
            ...
            <p><strong>Game-independent Automatic Move/position-tree Exhaustive-Search, Manipulation And Navigation</strong></p>
            ...
            <p>You can find GamesCrafters projects <a href="https://github.com/GamesCrafters">here</a>.</p>
            <h3>Related Links</h3>
            <ul>
                <li>Aaron Siegel's <a href="http://cgsuite.sourceforge.net/">CGSuite</a>.</li>
